...
func (o *CompleteProfileManagementFlowFound) Error() string {
	return fmt.Sprintf("[PUT /profiles][%d] completeProfileManagementFlowFound ", 302)
}
...
func (o *CompleteProfileManagementFlowInternalServerError) Error() string {
	return fmt.Sprintf("[PUT /profiles][%d] completeProfileManagementFlowInternalServerError  %+v", 500, o.Payload)
}
